...
class __TwigTemplate_63d35e609543f47c57998def73cac4763146deeb50303f4a0e708253be87bf6f extends Twig_Template
{
...
(isset($context["module"]) ? $context["module"] : null), "attributes", array()), "url_active", array()) != "buy")) {
      ...
      <div class=\"module-badges-action\">
        ...
        <div class=\"pull-right module-action\">
          ";
        // line 204
        $this->loadTemplate("PrestaShopBundle:Admin/Module/Includes:action_menu.html.twig", "@PrestaShop/Admin/Module/Includes/modal_read_more_content.html.twig", 204)->display(array_merge($context, array("module" => (isset($context["module"]) ? $context["module"] : null), "level" => (isset($context["level"]) ? $context["level"] : null))));
        // line 205
        echo "        </div>
      </div>
    </div>
...
";
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Module/Includes/modal_read_more_content.html.twig", "E:\\xampp\\htdocs\\prestashop\\demo\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\modal_read_more_content.html.twig");
    }
}
