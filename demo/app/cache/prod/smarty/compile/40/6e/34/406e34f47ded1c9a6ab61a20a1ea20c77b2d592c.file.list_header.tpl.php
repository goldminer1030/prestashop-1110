<?php /* Smarty version Smarty-3.1.19, created on 2017-11-10 08:22:57
         compiled from "E:\xampp\htdocs\prestashop\demo\admin030d4c6z9\themes\default\template\controllers\backup\helpers\list\list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:319725a05a831d638c4-37880557%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '406e34f47ded1c9a6ab61a20a1ea20c77b2d592c' => 
    array (
      0 => 'E:\\xampp\\htdocs\\prestashop\\demo\\admin030d4c6z9\\themes\\default\\template\\controllers\\backup\\helpers\\list\\list_header.tpl',
      1 => 1508764756,
      2 => 'file',
    ),
    'd330587c105b48aabb4bd0ec1795bbd02bd199bd' => 
    array (
      0 => 'E:\\xampp\\htdocs\\prestashop\\demo\\admin030d4c6z9\\themes\\default\\template\\helpers\\list\\list_header.tpl',
      1 => 1508764756,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '319725a05a831d638c4-37880557',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a05a8320c4908_77047922',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a05a8320c4908_77047922')) {function content_5a05a8320c4908_77047922($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'E:\\xampp\\htdocs\\prestashop\\demo\\vendor\\prestashop\\smarty\\plugins\\function.math.php';
?>
...
">
				<i class="icon-download"></i>
				<?php echo smartyTranslate(array('s'=>'Download the backup file (%s MB)','sprintf'=>array($_smarty_tpl->tpl_vars['backup_weight']->value),'d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>

			</a>
		</p>
		<p><?php echo smartyTranslate(array('s'=>'Tip: You can also download this file from your FTP server. Backup files are located in the "/adminXXXX/backups" directory.','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
</p>
	</div>
	<?php }?>
		...
		<div class="alert alert-warning">
			...
			<h4><?php echo smartyTranslate(array('s'=>'Disclaimer before creating a new backup','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</h4>
			<ol>
				<li><?php echo smartyTranslate(array('s'=>'PrestaShop is not responsible for your database, its backups and/or recovery.','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'PrestaShop is open-source software. You are using it at your own risk under the license agreement.','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'You should back up your data on a regular basis (both files and database).','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'This function only backs up your database, not your files.','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'By default, your existing database tables will be dropped during the backup recovery (see "Backup options" below).','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Always verify the quality and integrity of your backup files!','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Always verify that your backup files are complete, up-to-date and valid, even if you had a success message appear during the backup process.','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Always check your data.','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Never restore a backup on a live site.','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</li>
			</ol>
...
" method="post" class="form-horizontal">
				<button type="submit" class="btn btn-default">
					<i class="icon-save"></i>
					<?php echo smartyTranslate(array('s'=>'I have read the disclaimer. Please create a new backup.','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
		...
		<div class="alert alert-info">
			<h4><?php echo smartyTranslate(array('s'=>'How to restore a database backup','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</h4>
			<?php echo smartyTranslate(array('s'=>'If you need to restore a database backup, we invite you to subscribe to a [1][2]technical support plan[/2][/1].','html'=>true,'sprintf'=>array('[1]'=>'<strong>','[/1]'=>'</strong>','[2]'=>'<a class="_blank" href="http://addons.prestashop.com/support/16298-support-essentiel-plan.html">','[/2]'=>'</a>'),'d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>

			<br />
			<?php echo smartyTranslate(array('s'=>'Our team will take care of restoring your database safely.','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>

			<br />
			<br />
			<?php echo smartyTranslate(array('s'=>'Why can\'t I restore it by myself?','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>

			<br />
			<?php echo smartyTranslate(array('s'=>'Your shop is hosted by PrestaShop. Although you can create backup files here below, there are core settings you cannot access for security reasons, like the database management. Thus, only our team can proceed to a restoration.','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>

		</div>
		<?php } else { ?>
		<div class="alert alert-info">
			<h4><?php echo smartyTranslate(array('s'=>'How to restore a database backup in 10 easy steps','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</h4>
			<ol>
				<li><?php echo smartyTranslate(array('s'=>'Set "Enable Shop" to "No" in the "Maintenance" page under the "Preferences" menu.','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Download the backup from the list below or from your FTP server (in the folder "admin/backups").','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Check the backup integrity: Look for errors, incomplete file, etc... Be sure to verify all of your data.','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Please ask your hosting provider for "phpMyAdmin" access to your database.','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Connect to "phpMyAdmin" and select your current database.','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Unless you enabled the "Drop existing tables" option, you must delete all tables from your current database.','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'At the top of the screen, please select the "Import" tab','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Click on the "Browse" button and select the backup file from your hard drive.','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Check the maximum filesize allowed (e.g. Max: 16MB)'),$_smarty_tpl);?>
<br /><?php echo smartyTranslate(array('s'=>'If your backup file exceeds this limit, contact your hosting provider for assistance. ','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</li>
				<li><?php echo smartyTranslate(array('s'=>'Click on the "Go" button and please wait patiently for the import process to conclude. This may take several minutes.','d'=>'Admin.Advparameters.Help'),$_smarty_tpl);?>
</li>
			</ol>
		</div>
		<?php }?>
